# Generated by Powerlevel10k configuration wizard on 2020-12-22 at 14:02 CST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 23342.
# Wizard options: nerdfont-complete + powerline, large icons, unicode, lean, time,
# 2 lines, dotted, no frame, lightest-ornaments, compact, few icons, concise,
